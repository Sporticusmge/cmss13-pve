...
/datum/reagent/medical/adrenaline_concentrated
	...
	chemclass = CHEM_CLASS_COMMON
	properties = list(PROPERTY_PAINKILLING = 10, PROPERTY_ELECTROGENETIC = 6, PROPERTY_OXYGENATING = 3, PROPERTY_REVITALIZING = 1, PROPERTY_INTRAVENOUS = 1, PROPERTY_CARDIOTOXIC = 2, PROPERTY_DEFIBRILLATING = 1)
	flags = REAGENT_TYPE_MEDICAL | REAGENT_SCANNABLE
