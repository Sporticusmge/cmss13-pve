...
/obj/item/clothing/suit/storage/marine
	...
	valid_accessory_slots = list(ACCESSORY_SLOT_MEDAL, ACCESSORY_SLOT_PONCHO, ACCESSORY_SLOT_ARMOR_C, ACCESSORY_SLOT_GASMASK)
...
/obj/item/clothing/suit/storage/marine/MP/CO
	...
	valid_accessory_slots = list(ACCESSORY_SLOT_MEDAL, ACCESSORY_SLOT_RANK, ACCESSORY_SLOT_DECOR, ACCESSORY_SLOT_PONCHO, ACCESSORY_SLOT_ARMOR_C, ACCESSORY_SLOT_GASMASK)
