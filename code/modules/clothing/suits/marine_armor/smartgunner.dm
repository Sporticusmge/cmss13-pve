/obj/item/clothing/suit/storage/marine/smartgunner
	...
	valid_accessory_slots = list(ACCESSORY_SLOT_MEDAL, ACCESSORY_SLOT_SGPAINT, ACCESSORY_SLOT_PAINT, ACCESSORY_SLOT_PLATE, ACCESSORY_SLOT_PONCHO, ACCESSORY_SLOT_ARMOR_C)
