...
#define GAME_MASTER_AI_XENOS list(XENO_CASTE_DRONE, XENO_CASTE_SOLDIER, XENO_CASTE_RUNNER, RUNNER_ACIDER, XENO_CASTE_LURKER, XENO_CASTE_CRUSHER, XENO_CASTE_FACEHUGGER, PATHOGEN_CREATURE_NEOMORPH, PATHOGEN_CREATURE_SPRINTER, PATHOGEN_CREATURE_BLIGHT, PATHOGEN_CREATURE_BRUTE)
