...
/obj/item/weapon/gun/drg_gunner_minigun
	name = "\improper 'M90' Minigun"
	desc = "The M90 Minigun is a man-portable rotary heavy machine gun primarily used by the USCM against large armored targets."
	...
	fire_sound = 'sound/weapons/minigun_shots.wav'
	reload_sound = 'sound/weapons/scout_smg_reload.wav'
