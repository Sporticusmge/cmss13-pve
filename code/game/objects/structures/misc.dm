...
/obj/structure/roof/dropship_tail
	name = "UD-4 dropship"
...
/obj/structure/roof/dropship_canopy
	name = "UD-4 dropship"
	desc = "The canopy of the UD-4 Cheyenne dropship, it protects the pilot against the wind."
