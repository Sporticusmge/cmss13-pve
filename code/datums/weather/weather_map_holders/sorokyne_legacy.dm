...
/datum/weather_ss_map_holder/sorokyne_legacy
	name = "Sorokyne Legacy Map Holder"
...
/datum/weather_ss_map_holder/sorokyne_legacy/should_affect_area(area/A)
	return (A.temperature <= SOROKYNE_TEMPERATURE)

/datum/weather_ss_map_holder/sorokyne_legacy/should_start_event()
	if (prob(PROB_WEATHER_SOROKYNE))
		return TRUE
	return FALSE

/datum/weather_ss_map_holder/sorokyne_legacy/weather_warning()
