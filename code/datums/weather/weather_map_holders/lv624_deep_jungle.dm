/datum/weather_ss_map_holder/lv624_deep_jungle
...
/datum/weather_ss_map_holder/lv624_deep_jungle/should_affect_area(area/A)
	return !CEILING_IS_PROTECTED(A.ceiling, CEILING_GLASS)

/datum/weather_ss_map_holder/lv624_deep_jungle/should_start_event()
